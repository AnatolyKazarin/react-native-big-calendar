      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Text,
            {
              style: [theme.typography.xs, u['text-center'], { color: theme.palette.gray['300'] }],
            },
            date.format('ddd'),
          ),
          React.createElement(
        ...
        React.createElement(
          ...
          allDayEvents.map(function (event) {
            ...
            return React.createElement(
              View,
              { style: [eventCellCss.style, primaryBg], key: '' + event.start + event.title },
              React.createElement(
                Text,
                {
                  style: {
...
function _CalendarContainer(_a) {
  var events = _a.events,
    ...
    HeaderComponentForMonthView = _o === void 0 ? CalendarHeaderForMonthView : _o,
    _p = _a.weekEndsOn,
    weekEndsOn = _p === void 0 ? 6 : _p,
    _q = _a.maxVisibleEventCount,
    maxVisibleEventCount = _q === void 0 ? 3 : _q
  var _r = React__default.useState(dayjs(date)),
    targetDate = _r[0],
    setTargetDate = _r[1]
  React__default.useEffect(
    function () {
